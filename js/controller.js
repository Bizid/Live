...
var name = document.getElementById("tankname").value;
  ...
  $scope.addWaterWells = function() {
  console.log("Water Wells");
    var coord = getRandomLeftTop();
    fabric.Image.fromURL('./images/well.png' , function(image) {
      image.set({
        left: coord.left,
        top: coord.top,
        scaleX: 0.1,
 ...
 $scope.addPumps = function() {
  console.log("add Pumps");
    var coord = getRandomLeftTop();
    fabric.Image.fromURL('./images/centrifigalpump.png' , function(image) {
      image.set({
        left: coord.left,
...
$scope.addChargePumps = function() {
  console.log("add Charge Pumps");
    var coord = getRandomLeftTop();
    fabric.Image.fromURL('./images/chargepump.png' , function(image) {
      image.set({
        left: coord.left,
        top: coord.top,
        scaleX: 0.2,
...
$scope.addTrashPumps = function() {
  console.log("add Trash Pumps");
    var coord = getRandomLeftTop();
    fabric.Image.fromURL('./images/tpump.png' , function(image) {
      image.set({
        left: coord.left,
        top: coord.top,
        scaleX: 0.7,
  ...
  $scope.addBoosterPumps = function() {
  console.log("add Booster Pumps");
    var coord = getRandomLeftTop();
    fabric.Image.fromURL('./images/tpump.png' , function(image) {
      image.set({
        left: coord.left,
   ...
   $scope.addFilterSystems = function() {
  console.log("add Filter Systems");
    var coord = getRandomLeftTop();
    fabric.Image.fromURL('./images/filterskid.png' , function(image) {
      image.set({
        left: coord.left,
        top: coord.top,
        scaleX: 0.7,
  ...
  console.log("add Pipelines");
    var coord = getRandomLeftTop();
    fabric.Image.fromURL('./images/lanepipe.png' , function(image) {
      image.set({
        left: coord.left,
        top: coord.top,
        scaleX: 0.1,
  ...
  $scope.addFlowMeters = function() {
  console.log("add FlowMeters");
    var coord = getRandomLeftTop();
    fabric.Image.fromURL('./images/Flowmeter.png' , function(image) {
      image.set({
        left: coord.left,
        top: coord.top,
        scaleX: 0.3,
  ...
  $scope.addFlowMeterGroups = function() {
  console.log("add FlowMeter Groups");
    var coord = getRandomLeftTop();
    fabric.Image.fromURL('./images/Flowmeter.png' , function(image) {
      image.set({
        left: coord.left,
  ...
  $scope.addActuators = function() {
  console.log("add Actuators");
    var coord = getRandomLeftTop();
    fabric.Image.fromURL('./images/Flowmeter.png' , function(image) {
      image.set({
        left: coord.left,
  ...
  console.log("add Sensors");
   ...
   $scope.addTotalIntakeMeter = function() {
  console.log("add Total Intake Meter");
    var coord = getRandomLeftTop();
    fabric.Image.fromURL('./images/Flowmeter.png' , function(image) {
      image.set({
        left: coord.left,
  ...
  $scope.addControlBoxes = function() {
  console.log("add Control Boxes");
    var coord = getRandomLeftTop();
    fabric.Image.fromURL('./images/controlbox.png' , function(image) {
      image.set({
        left: coord.left,
        top: coord.top,
        scaleX: 0.2,
  ...
  $scope.addPowerSupplies = function() {
  console.log("add Power Supplies");
    var coord = getRandomLeftTop();
    fabric.Image.fromURL('./images/powerSupplyOn.png' , function(image) {
      image.set({
        left: coord.left,
        top: coord.top,
        scaleX: 0.3,
  ...
  $scope.addPressureSensors = function() {
  console.log("add Pressure Sensors");
    var coord = getRandomLeftTop();
    fabric.Image.fromURL('./images/powerSupplyOn.png' , function(image) {
      image.set({
        left: coord.left,
  ...
  $scope.addWellInjection = function() {
  console.log("add Well Injection");
    var coord = getRandomLeftTop();
    fabric.Image.fromURL('./images/well_head_tree.png' , function(image) {
      image.set({
        left: coord.left,
        top: coord.top,
        scaleX: 0.3,
...
console.log("ddd");
  ...
  $scope.setConsoleJSON = function(value) {
    console.log("Set console into JSON");
...
function createSVGGauge(name, label, min, max)
      {
        var config = 
        {
          size: 120,
